...
test("kicad-to-circuit-json repro: OV9281 dual camera board PCB", () => {
  ...
  converter.addFile("ov9281-dual-camera-board.kicad_pcb", kicadPcbContent)
  ...
  const snapshotDir = path.join(path.dirname(import.meta.path), "__snapshots__")
  mkdirSync(snapshotDir, { recursive: true })
  writeFileSync(
    path.join(snapshotDir, "ov9281-dual-camera-board-circuit-json.json"),
