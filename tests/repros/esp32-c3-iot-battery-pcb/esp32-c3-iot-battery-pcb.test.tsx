...
test("kicad-to-circuit-json repro: ESP32-C3 IoT Battery PCB", async () => {
  const kicadPcbPath =
    "tests/repros/esp32-c3-iot-battery-pcb/esp32-c3-iot-battery-pcb.kicad_pcb"
  const kicadPcbContent = readFileSync(kicadPcbPath, "utf-8")

  const converter = new KicadToCircuitJsonConverter()
  converter.addFile("esp32-c3-iot-battery-pcb.kicad_pcb", kicadPcbContent)
  ...
  await fs.mkdir("tests/repros/esp32-c3-iot-battery-pcb/__snapshots__", {
    recursive: true,
  })
  await fs.writeFile(
    "tests/repros/esp32-c3-iot-battery-pcb/__snapshots__/esp32-c3-iot-battery-pcb-circuit-json.json",
  ...
  await fs.writeFile(
    "tests/repros/esp32-c3-iot-battery-pcb/__snapshots__/esp32-c3-iot-battery-pcb-circuit-json.svg",
    circuitJsonSvg,
  )
