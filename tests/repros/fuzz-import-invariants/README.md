...
The five ID/reference/schema/geometry evidence JSON files remain characterization tests in this first stack layer. IDs and missing logical references are not reliably visible in a PCB render; their tests stay as data assertions instead of fabricated images.
